...
\begin{figure}[h]
  ...
  \begin{subfigure}[t]{0.23\textwidth}
    ...
    \caption{$\sigma_2^{-1}$}
  \end{subfigure}
  \caption{Representatives in $\exptwothree S^1$ of the homotopy classes corresponding to the generators of the braid group, $\sigma_1$ and $\sigma_2$, along with their inverses.}
  \label{fig:gen_paths_under_iso_shared}
\end{figure}

\section{Decomposing periodic orbits in $\exptwothree S^1$}
