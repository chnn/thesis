...
In this thesis we describe the periodic orbits of the modular flow, a dynamical system in a space of lattices $\LS_1$.
...
Using our analysis of the modular flow in $\exptwothree S^1$, we present a computer-aided diagrammatic system for decomposing homotopy-classes of periodic orbits as braids in the braid group $B^3$.
