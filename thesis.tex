...
Now, recall that the hyperbolic elements of $\SLZ$ and $\PSLZ$ are those with trace greater than 2, and that we are interested in the hyperbolic elements because the conjugacy class of such an element defines a periodic orbit of the modular flow.
