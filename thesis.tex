...
\end{align*}
Thus the image of $P(\Z^2)$ by $\delta_t$ as $0 \leq t \leq T$ is a periodic orbit of orbit time $T$, and we have the following proposition.

\begin{prop}\label{prop:hyperbolic_defines_flow}
  Every hyperbolic matrix in $\SLZ$ defines a periodic orbit of the modular flow.
\end{prop}
...
If we continuously act upon $P$ by $\delta_t$ as $0 \leq t \leq T$, we observe a periodic orbit in the space of lattices. This orbit is visualized in Figure~\ref{fig:periodic_orbits_lattice}.
